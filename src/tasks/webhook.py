    ...
    try:
        ...
        if existing_anime:
            ...
            if favorited_source:
                ...
                task_coro = lambda session, cb: generic_import_task(
                    ...
                    doubanId=doubanId, tmdbId=tmdbId, imdbId=imdbId, tvdbId=tvdbId,
                    bangumiId=bangumiId,
        ...
        if best_match is not None:
            ...
            task_coro = lambda session, cb: generic_import_task(
                ...
                season=season, currentEpisodeIndex=currentEpisodeIndex, imageUrl=best_match.imageUrl,
                config_manager=config_manager, metadata_manager=metadata_manager,
                progress_callback=cb, session=session, manager=manager,
                task_manager=task_manager, rate_limiter=rate_limiter,
                title_recognition_manager=title_recognition_manager,
